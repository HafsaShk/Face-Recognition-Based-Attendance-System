...
imgSania = face_recognition.load_image_file('Attendance_System_Us/Images_Attendance/Sania Mirza.jpg')
imgSania = cv2.cvtColor(imgSania, cv2.COLOR_BGR2RGB)
imgTest = face_recognition.load_image_file('Attendance_System_Us/Images_Attendance/Sania Mirza test.jpg')
